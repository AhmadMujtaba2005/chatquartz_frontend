...
const CheckIcon = () => (
    <svg className="w-[18px] h-[18px] text-[#2B64FD] shrink-0 mr-3 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
            ...
            <SmoothScroll>
                ...
                <div className="relative w-full bg-gradient-to-b from-[#AAC8FD] to-[#FFFFFF] min-h-screen flex flex-col pt-[64px] sm:pt-[88px] md:pt-[112px] overflow-x-hidden">
                    ...
                    <div className="relative z-10 flex-grow flex flex-col items-center">
                        ...
                        <h1 className="text-[36px] sm:text-[48px] md:text-[56px] leading-[1.1] mb-6 text-center tracking-tight text-gray-900">
                            Sample <span className="font-bold text-[#2B64FD] italic">Pricing</span> For Every Business
                        </h1>
                ...
                <RevealOnScroll>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-[1200px] mx-auto w-[94%] mt-16 sm:mt-24 md:mt-[120px] mb-20">
                        {/* Starter Plan */}
                        <div className="relative bg-white/60 backdrop-blur-md rounded-[32px] border border-[#AAC8FD]/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_15px_40px_rgb(43,100,253,0.15)] hover:-translate-y-2 p-8 flex flex-col transition-all duration-500 hover:border-[#2B64FD]/40 group">
                            <div className="absolute inset-0 rounded-[32px] bg-gradient-to-br from-[#AAC8FD]/10 via-transparent to-[#2B64FD]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
                            ...
                            <div className="relative z-10 text-[36px] font-bold text-[#2B64FD] mb-8">$9<span className="text-[18px] text-gray-500 font-medium">/month</span></div>
                        ...
                        {/* Professional Plan */}
                        <div className="relative bg-white/70 backdrop-blur-md rounded-[32px] border-2 border-[#2B64FD]/80 shadow-[0_8px_30px_rgb(43,100,253,0.15)] hover:shadow-[0_20px_50px_rgb(43,100,253,0.25)] hover:-translate-y-2 p-8 flex flex-col transition-all duration-500 mt-4 md:mt-0 group">
                            <div className="absolute inset-0 rounded-[32px] bg-gradient-to-br from-[#2B64FD]/5 via-transparent to-[#2B64FD]/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
                            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#2B64FD] text-white px-5 py-1.5 rounded-full text-[12px] font-bold tracking-widest uppercase shadow-md z-20">Most Popular</div>
                            ...
                            <div className="relative z-10 text-[36px] font-bold text-[#2B64FD] mb-8">$15<span className="text-[18px] text-gray-500 font-medium">/month</span></div>
                            ...
                            <div className="relative z-10 bg-[#2B64FD]/[0.03] backdrop-blur-sm -mx-8 -mb-8 p-8 rounded-b-[30px] border-t border-[#2B64FD]/20 mt-auto">
                                <div className="text-[15px] font-semibold mb-2 text-[#2B64FD]">Best for:</div>
                        ...
                        <div className="relative bg-white/60 backdrop-blur-md rounded-[32px] border border-[#AAC8FD]/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_15px_40px_rgb(43,100,253,0.15)] hover:-translate-y-2 p-8 flex flex-col transition-all duration-500 hover:border-[#2B64FD]/40 group">
                            ...
                            <div className="relative z-10 text-[32px] font-bold text-[#2B64FD] mb-8 mt-1">Custom Pricing</div>
