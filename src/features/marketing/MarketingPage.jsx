                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8 w-[95%] max-w-[950px] mx-auto mt-16 sm:mt-24 md:mt-[100px]">
                    <RevealOnScroll>
                        <div className="relative flex flex-col h-full p-6 sm:p-7 lg:p-8 rounded-[32px] border border-brand-secondary/50 bg-white/60 backdrop-blur-md shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_15px_40px_rgb(43,100,253,0.15)] hover:border-brand-primary/40 transition-all duration-500 hover:-translate-y-2 cursor-pointer group overflow-hidden">
                            ...
                            <p className="relative z-10 text-[13px] sm:text-[14px] text-gray-600 leading-relaxed mt-auto">Proactively reach out the moment a visitor shows interest — no manual trigger needed.</p>
                        </div>
                    </RevealOnScroll>
                    <RevealOnScroll>
                        <div className="relative flex flex-col h-full p-6 sm:p-7 lg:p-8 rounded-[32px] border border-brand-secondary/50 bg-white/60 backdrop-blur-md shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_15px_40px_rgb(43,100,253,0.15)] hover:border-brand-primary/40 transition-all duration-500 hover:-translate-y-2 cursor-pointer group overflow-hidden">
                            ...
                            <p className="relative z-10 text-[13px] sm:text-[14px] text-gray-600 leading-relaxed mt-auto">Automatically greet every visitor on arrival — multilingual and fully customizable.</p>
                        </div>
                    </RevealOnScroll>
                    <RevealOnScroll>
                        <div className="relative flex flex-col h-full p-6 sm:p-7 lg:p-8 rounded-[32px] border border-brand-secondary/50 bg-white/60 backdrop-blur-md shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_15px_40px_rgb(43,100,253,0.15)] hover:border-brand-primary/40 transition-all duration-500 hover:-translate-y-2 cursor-pointer group overflow-hidden">
                            ...
                            <p className="relative z-10 text-[13px] sm:text-[14px] text-gray-600 leading-relaxed mt-auto">Capture email or phone when agents are offline, so no lead goes cold.</p>
                        </div>
                    </RevealOnScroll>
                    <RevealOnScroll>
                        <div className="relative flex flex-col h-full p-6 sm:p-7 lg:p-8 rounded-[32px] border border-brand-secondary/50 bg-white/60 backdrop-blur-md shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_15px_40px_rgb(43,100,253,0.15)] hover:border-brand-primary/40 transition-all duration-500 hover:-translate-y-2 cursor-pointer group overflow-hidden">
                            ...
                            <p className="relative z-10 text-[13px] sm:text-[14px] text-gray-600 leading-relaxed mt-auto">Grow your email list automatically, with confirmation and newsletter integration built-in.</p>
                        </div>
                    </RevealOnScroll>
                </div>
