        ...
        <div>
            <SmoothScroll>
                ...
                <div className="w-full bg-gradient-to-b from-[#AAC8FD] to-[#FFFFFF] pb-20">
                    <Navbar />
                    <h1 className="text-5xl sm:text-6xl font-bold leading-tight text-black mt-28 mb-6 text-center tracking-tight">
                        Privacy Policy
                    </h1>
                    <div className="max-w-4xl px-6 mx-auto text-center space-y-5 text-[14px] text-gray-700 leading-relaxed font-medium">
                        ...
                        <p>
                            For the purposes of this Policy, our &ldquo;Services&rdquo; refer to the main plugin &ldquo;Support Board&rdquo; and to any other &ldquo;App&rdquo; like Slack App or Artificial Intelligence app, &ldquo;our Website&rdquo; refers to <a href="https://board.support/" target="_blank" rel="noopener noreferrer" className="text-[#2B64FD] font-semibold hover:underline">https://board.support/</a> and sub-domains, and &ldquo;we&rdquo;, &ldquo;us&rdquo;, &ldquo;our&rdquo; refer to our company SCHIOCCO LTD.
                        </p>
                        <p>
                ...
                <div className="w-[92%] max-w-[960px] mx-auto my-8 mb-24 space-y-8 text-gray-700">
                    ...
                    <RevealOnScroll>
                        <section className="bg-white border border-gray-200/80 rounded-2xl p-8 sm:p-10 shadow-sm hover:shadow-md transition-all duration-200">
                            ...
                            <p className="text-[14px] leading-relaxed">
                                In this Policy, personal information means information relating to an identified or identifiable natural person, business or legal entity. An identifiable person is one who can be identified, directly or indirectly, in particular by reference to an identification number or to one or more factors specific to his physical, physiological, mental, economic, cultural or social identity. Except as described in this Policy, Support Board currently doesn&rsquo;t sell, rent or loan any personal information to any third party, but Support Board keep the right to change this policy in future and sell or rent any personal information to any third party at any time.
                            </p>
                        </section>
                    </RevealOnScroll>
                    ...
                    <RevealOnScroll>
                        <section className="bg-white border border-gray-200/80 rounded-2xl p-8 sm:p-10 shadow-sm hover:shadow-md transition-all duration-200">
                            ...
                            <p className="text-[14px] leading-relaxed">
                                By buying the Support Board plugin you provide to Envato(<a href="https://envato.com" target="_blank" rel="noopener noreferrer" className="text-[#2B64FD] font-semibold hover:underline">https://envato.com</a>) personal information, more details here. We do not currently process or share any of your personal data.
                            </p>
                        </section>
                    </RevealOnScroll>
                    ...
                    <RevealOnScroll>
                        <section className="bg-white border border-gray-200/80 rounded-2xl p-8 sm:p-10 shadow-sm hover:shadow-md transition-all duration-200">
                            ...
                            <p className="text-[14px] leading-relaxed">
                                When you synchronize Support Board with Dialoglow(<a href="https://dialogflow.com/" target="_blank" rel="noopener noreferrer" className="text-[#2B64FD] font-semibold hover:underline">https://dialogflow.com/</a>) to use the Diaogflow Bot, or Google services like language translation, we collect the following personal information: refresh token, Envato purchase code, email, picture, locale, profile picture. By voluntarily providing us with Account Information, you hereby represent that you are the owner of such personal information or are otherwise authorized to provide it to us. All Service Data is subject to our technical safeguards as more fully subscribed in our Terms of Service. By using Dialogflow with Support Board only the Refresh Token(an alphanumeric string) is sent to our server. No other data are sent or stored in our server. If you don&rsquo;t want to share or send any data with us, please contact us here and we will send you a tutorial to configure Support Board in order to use your own Dialogflow integration. By using Dialogflow you provide to Dialogflow personal information, more details here. By buying the License for our Artificial Intelligence app you provide to us your email, name and to Gumroad(<a href="https://gumroad.com/" target="_blank" rel="noopener noreferrer" className="text-[#2B64FD] font-semibold hover:underline">https://gumroad.com/</a>) personal information, more details here.
                            </p>
                        </section>
                    </RevealOnScroll>
                    ...
                    <RevealOnScroll>
                        <section className="bg-white border border-gray-200/80 rounded-2xl p-8 sm:p-10 shadow-sm hover:shadow-md transition-all duration-200">
                            ...
                            <p className="text-[14px] leading-relaxed">
                                When you synchronize Support Board with other external services, you share information with the external service according to the external service&rsquo;s terms of service.
                            </p>
                        </section>
                    </RevealOnScroll>
                    ...
                    <RevealOnScroll>
                        <section className="bg-white border border-gray-200/80 rounded-2xl p-8 sm:p-10 shadow-sm hover:shadow-md transition-all duration-200">
                            ...
                            <p className="text-[14px] leading-relaxed">
                                The types of information covered in the policy are textual information like your email. We don&rsquo;t keep other type of data related to you.
                            </p>
                        </section>
                    </RevealOnScroll>
                    ...
                    <RevealOnScroll>
                        <section className="bg-white border border-gray-200/80 rounded-2xl p-8 sm:p-10 shadow-sm hover:shadow-md transition-all duration-200">
                            ...
                            <p className="text-[14px] leading-relaxed">
                                We don&rsquo;t have a time limit for keeping your information but if you can contact us here and request the permanent deleting of your information from our system and database. We will delete your information within 7 days from the day we receive your request.
                            </p>
                        </section>
                    </RevealOnScroll>
                    ...
                    <RevealOnScroll>
                        <section className="bg-white border border-gray-200/80 rounded-2xl p-8 sm:p-10 shadow-sm hover:shadow-md transition-all duration-200">
                            ...
                            <p className="text-[14px] leading-relaxed">
                                We store your information in our secure database. We don&rsquo;t share access to our database to any third party entity.
                            </p>
                        </section>
                    </RevealOnScroll>
