            ...
            <SmoothScroll>
                ...
                <div className="max-w-[800px] mx-auto w-[90%] mt-4 sm:mt-8 mb-20 text-gray-700 leading-relaxed text-[15px]">
                    ...
                    <section className="mb-10">
                        ...
                        <div className="pl-4 border-l-2 border-brand-secondary flex flex-col gap-3 mt-4">
                    ...
                    <section className="mb-10">
                        ...
                        <div className="pl-4 border-l-2 border-brand-secondary flex flex-col gap-3 mt-4 mb-4">
                    ...
                    <section className="mb-10">
                        ...
                        <p className="mb-4"><a href="https://board.support/slack" target="_blank" rel="noopener noreferrer" className="font-semibold text-brand-primary hover:underline">The Slack app</a> has no recurring costs but we reserve the right to terminate the service at any time if we deem it necessary. The main reason for stopping the service is the sending / receiving of too many messages. While we offer the Slack integration for free, our servers must process every message sent to make the integration works, and this have costs (we pay for it). In the case we decide to stop the service:</p>
                        <div className="pl-4 border-l-2 border-brand-secondary flex flex-col gap-3 mt-4">
                    ...
                    <section className="mb-10">
                        ...
                        <p className="mb-4"><a href="https://board.support/messenger" target="_blank" rel="noopener noreferrer" className="font-semibold text-brand-primary hover:underline">The Messenger app</a> has no recurring costs but we reserve the right to terminate the service at any time if we deem it necessary. The main reason for stopping the service is the sending / receiving of too many messages. While we offer the Messenger integration for free, our servers must process every message sent to make the integration works, and this have costs (we pay for it). In the case we decide to stop the service:</p>
                        <div className="pl-4 border-l-2 border-brand-secondary flex flex-col gap-3 mt-4">
                    ...
                    <section className="mb-10">
                        ...
                        <p>You are not allowed to re-sell or distribute Support Board, including parts of it, and including as a SAAS, on the <a href="https://www.envato.com/" target="_blank" rel="noopener noreferrer" className="font-semibold text-brand-primary hover:underline">Envato marketplace</a> (including <a href="https://codecanyon.net/" target="_blank" rel="noopener noreferrer" className="font-semibold text-brand-primary hover:underline">CodeCanyon</a>) and the <a href="https://appsumo.com/" target="_blank" rel="noopener noreferrer" className="font-semibold text-brand-primary hover:underline">AppSumo marketplace</a> in any circumstance.</p>
                    </section>
                    ...
                    <section className="mb-10">
                        ...
                        <ul className="list-none space-y-3 mb-6 pl-4 border-l-2 border-brand-secondary">
                    ...
                    <section>
                        ...
                        <p><span className="font-bold">By email:</span><br />
                            <a href="mailto:support@board.support" className="text-brand-primary hover:underline font-medium">support@board.support</a></p>
                    </section>
                </div>
