                ...
                <div className="relative w-full bg-gradient-to-b from-[#AAC8FD] to-[#FFFFFF] min-h-screen flex flex-col pt-[64px] sm:pt-[88px] md:pt-[112px] overflow-x-hidden">
                    ...
                    <div className="relative z-10 flex-grow flex flex-col items-center">
                        ...
                        <h1 className="text-[36px] sm:text-[48px] md:text-[56px] leading-[1.1] mb-6 text-center tracking-tight text-gray-900">
                            Elevate Your <span className="font-bold text-[#2B64FD] italic">Support</span> With Advanced Tools
                        </h1>
                ...
                <RevealOnScroll>
                    <div className="max-w-[1200px] mx-auto w-[94%] mt-16 sm:mt-24 md:mt-[120px] flex flex-col gap-6 md:gap-8 mb-20">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                            <div className="relative bg-white/60 backdrop-blur-md rounded-[32px] border border-[#AAC8FD]/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_15px_40px_rgb(43,100,253,0.15)] hover:-translate-y-2 p-8 md:p-10 flex flex-col transition-all duration-500 hover:border-[#2B64FD]/40 group overflow-hidden">
