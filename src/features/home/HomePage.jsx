                    ...
                    <div className="flex flex-col items-center mt-16 sm:mt-24 md:mt-[120px] px-4">
                        ...
                        <div className="flex flex-col gap-14 md:gap-20 w-[95%] max-w-[1150px] mx-auto mt-12 sm:mt-16">
                            ...
                            <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
                                <div className="w-full lg:w-[65%] relative rounded-2xl overflow-hidden border border-gray-200 shadow-[0_20px_50px_rgba(124,58,237,0.08)] hover:shadow-[0_25px_60px_rgba(124,58,237,0.15)] transition-shadow duration-500 group bg-gray-50">
                                    <div className="aspect-[16/10] w-full relative">
                                        <img src="/images/step.png" alt="Step 1 Preview" loading="lazy" className="absolute top-0 left-0 w-full h-full object-cover object-top group-hover:scale-[1.02] transition-transform duration-700 ease-out hue-rotate-[45deg]" />
                                    </div>
                                </div>
                            ...
                            <RevealOnScroll>
                                ...
                                <div className="w-full lg:w-[65%] relative rounded-2xl overflow-hidden border border-gray-200 shadow-[0_20px_50px_rgba(124,58,237,0.08)] hover:shadow-[0_25px_60px_rgba(124,58,237,0.15)] transition-shadow duration-500 group bg-gray-50">
                                    <div className="aspect-[16/10] w-full relative">
                                        <img src="/images/step1.png" alt="Step 2 Preview" loading="lazy" className="absolute top-0 left-0 w-full h-full object-cover object-top group-hover:scale-[1.02] transition-transform duration-700 ease-out hue-rotate-[45deg]" />
                                    </div>
                                </div>
                                <div className="w-full lg:w-[35%] flex flex-col items-start text-left">
                                    <div className="flex items-center gap-4 mb-3">
                            ...
                            <RevealOnScroll>
                                ...
                                <div className="w-full lg:w-[65%] relative rounded-2xl overflow-hidden border border-gray-200 shadow-[0_20px_50px_rgba(124,58,237,0.08)] hover:shadow-[0_25px_60px_rgba(124,58,237,0.15)] transition-shadow duration-500 group bg-gray-50">
                                    <div className="aspect-[16/10] w-full relative">
                                        <img src="/images/step2.png" alt="Step 3 Preview" loading="lazy" className="absolute top-0 left-0 w-full h-full object-cover object-top group-hover:scale-[1.02] transition-transform duration-700 ease-out hue-rotate-[45deg]" />
                                    </div>
                                </div>
                                <div className="w-full lg:w-[35%] flex flex-col items-start text-left">
                                    <div className="flex items-center gap-4 mb-3">
                            ...
                            <RevealOnScroll>
                                ...
                                <div className="w-full lg:w-[65%] relative rounded-2xl overflow-hidden border border-gray-200 shadow-[0_20px_50px_rgba(124,58,237,0.08)] hover:shadow-[0_25px_60px_rgba(124,58,237,0.15)] transition-shadow duration-500 group bg-gray-50">
                                    <div className="aspect-[16/10] w-full relative">
                                        <img src="/images/step3.png" alt="Step 4 Preview" loading="lazy" className="absolute top-0 left-0 w-full h-full object-cover object-top group-hover:scale-[1.02] transition-transform duration-700 ease-out hue-rotate-[45deg]" />
                                    </div>
                                </div>
                                <div className="w-full lg:w-[35%] flex flex-col items-start text-left">
                                    <div className="flex items-center gap-4 mb-3">
