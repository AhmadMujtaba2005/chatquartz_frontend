    ...
    return (
        <main>
            <SmoothScroll>
                ...
                <div className="relative w-full min-h-screen flex flex-col justify-center items-center bg-gradient-to-b from-[#0F0A1F] via-[#1E0B4A] to-[#5B21B6] pt-[64px] sm:pt-[88px] md:pt-[112px] pb-[64px] sm:pb-[88px] md:pb-[112px] overflow-x-hidden">
                    <HeroNetworkCanvas animated={true} />

                    <RevealOnScroll className="relative z-10 flex flex-col items-center w-full px-4">
                        <h1 className="text-[36px] sm:text-[48px] md:text-[56px] leading-[1.1] text-white mb-6 text-center tracking-tight px-4">
                        ...
                        <div className="max-w-3xl mx-auto px-6 h-[72px] sm:h-[48px] flex items-center justify-center">
                            <p className="text-[15px] sm:text-[16px] text-purple-200 text-center leading-relaxed m-0 w-full">
                                <TypewriterEffect
                                    sentences={[
                        ...
                        <div className="flex flex-col items-center my-8 sm:my-10 w-full">
                            ...
                            <div className="flex items-center justify-center gap-4 sm:gap-6 flex-wrap">
                                <span className="flex items-center gap-1.5 text-[13px] text-purple-300">✓ No credit card required</span>
                                <span className="flex items-center gap-1.5 text-[13px] text-purple-300">✓ No setup fees</span>
                            </div>
                        </div>
                    </RevealOnScroll>
                </div>
                    ...
                    <div className="flex flex-col items-center mt-16 sm:mt-24 md:mt-[120px] px-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 w-[95%] max-w-[1150px] mx-auto mt-12 sm:mt-16">
                            <div className="relative bg-white/60 backdrop-blur-md rounded-[32px] border border-brand-secondary/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_15px_40px_rgb(124,58,237,0.15)] hover:-translate-y-2 flex flex-col h-full p-7 lg:p-8 transition-all duration-500 hover:border-brand-primary/40 group overflow-hidden cursor-pointer">
                                ...
                                <Image src="/boost.png" alt="boost" width={64} height={64} className="h-16 w-16 object-contain rounded-lg mb-6 brightness-0" />
                            ...
                            <div className="relative bg-white/60 backdrop-blur-md rounded-[32px] border border-brand-secondary/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_15px_40px_rgb(124,58,237,0.15)] hover:-translate-y-2 flex flex-col h-full p-7 lg:p-8 transition-all duration-500 hover:border-brand-primary/40 group overflow-hidden cursor-pointer">
                                <div className="absolute inset-0 bg-gradient-to-br from-brand-secondary/10 via-transparent to-brand-primary/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
                                <Image src="/light.png" alt="light" width={64} height={64} className="h-16 w-16 object-contain rounded-lg mb-6 brightness-0" />
                            ...
                            <div className="relative bg-white/60 backdrop-blur-md rounded-[32px] border border-brand-secondary/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_15px_40px_rgb(124,58,237,0.15)] hover:-translate-y-2 flex flex-col h-full p-7 lg:p-8 transition-all duration-500 hover:border-brand-primary/40 group overflow-hidden cursor-pointer">
                                <div className="absolute inset-0 bg-gradient-to-br from-brand-secondary/10 via-transparent to-brand-primary/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
                                <Image src="/effortless.png" alt="effortless" width={64} height={64} className="h-16 w-16 object-contain rounded-lg mb-6 brightness-0" />
                            ...
                            <div className="relative bg-white/60 backdrop-blur-md rounded-[32px] border border-brand-secondary/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_15px_40px_rgb(124,58,237,0.15)] hover:-translate-y-2 flex flex-col h-full p-7 lg:p-8 transition-all duration-500 hover:border-brand-primary/40 group overflow-hidden cursor-pointer">
                                <div className="absolute inset-0 bg-gradient-to-br from-brand-secondary/10 via-transparent to-brand-primary/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
                                <Image src="/24-hours.png" alt="24-hours" width={64} height={64} className="h-16 w-16 object-contain rounded-lg mb-6 brightness-0" />
                            ...
                            <div className="relative bg-white/60 backdrop-blur-md rounded-[32px] border border-brand-secondary/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_15px_40px_rgb(124,58,237,0.15)] hover:-translate-y-2 flex flex-col h-full p-7 lg:p-8 transition-all duration-500 hover:border-brand-primary/40 group overflow-hidden cursor-pointer">
                                <div className="absolute inset-0 bg-gradient-to-br from-brand-secondary/10 via-transparent to-brand-primary/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
                                <Image src="/faster.png" alt="faster" width={64} height={64} className="h-16 w-16 object-contain rounded-lg mb-6 brightness-0" />
                            ...
                            <div className="relative bg-white/60 backdrop-blur-md rounded-[32px] border border-brand-secondary/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_15px_40px_rgb(124,58,237,0.15)] hover:-translate-y-2 flex flex-col h-full p-7 lg:p-8 transition-all duration-500 hover:border-brand-primary/40 group overflow-hidden cursor-pointer">
                                <div className="absolute inset-0 bg-gradient-to-br from-brand-secondary/10 via-transparent to-brand-primary/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
                                <Image src="/conversion.png" alt="conversion" width={64} height={64} className="h-16 w-16 object-contain rounded-lg mb-6 brightness-0" />
                ...
                <RevealOnScroll>
                    ...
                    <GlobalCTA
                        title={<>Experience <span className="italic text-brand-primary">chatquartz</span> in Action</>}
                        description="See chatquartz handle a real conversation — no signup required!"
                        buttonText="Contact Sales"
                        buttonLink="/contactus"
                        containerClassName="mt-16 sm:mt-24 md:mt-[120px] px-5 py-12 sm:p-16"
                    ...
                    <div className="flex flex-col gap-14 md:gap-20 w-[95%] max-w-[1150px] mx-auto mt-12 sm:mt-16">
                            ...
                            <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
                                <div className="w-full lg:w-[65%] relative rounded-2xl overflow-hidden border border-gray-200 shadow-[0_20px_50px_rgba(124,58,237,0.08)] hover:shadow-[0_25px_60px_rgba(124,58,237,0.15)] transition-shadow duration-500 group bg-gray-50">
                                    <div className="aspect-[16/10] w-full relative">
                                        <Image src="/images/step.png" alt="Step 1 Preview" priority fill sizes="(max-width: 1024px) 100vw, 65vw" className="object-cover object-top group-hover:scale-[1.02] transition-transform duration-700 ease-out hue-rotate-[45deg]" />
                                    </div>
                                </div>
                                <div className="w-full lg:w-[35%] flex flex-col items-start text-left">
                                    <div className="flex items-center gap-4 mb-3">
                                        <span className="flex items-center justify-center w-11 h-11 rounded-2xl bg-gradient-to-br from-[#7C3AED]/10 to-[#7C3AED]/5 text-[#7C3AED] text-xl font-extrabold shadow-sm border border-[#7C3AED]/10 flex-shrink-0">1</span>
                        ...
                        <RevealOnScroll>
                            <div className="flex flex-col lg:flex-row-reverse items-center gap-8 lg:gap-16">
                                <div className="w-full lg:w-[65%] relative rounded-2xl overflow-hidden border border-gray-200 shadow-[0_20px_50px_rgba(124,58,237,0.08)] hover:shadow-[0_25px_60px_rgba(124,58,237,0.15)] transition-shadow duration-500 group bg-gray-50">
                                    <div className="aspect-[16/10] w-full relative">
                                        <Image src="/images/step1.png" alt="Step 2 Preview" priority fill sizes="(max-width: 1024px) 100vw, 65vw" className="object-cover object-top group-hover:scale-[1.02] transition-transform duration-700 ease-out hue-rotate-[45deg]" />
                                    </div>
                                </div>
                                <div className="w-full lg:w-[35%] flex flex-col items-start text-left">
                                    <div className="flex items-center gap-4 mb-3">
                                        <span className="flex items-center justify-center w-11 h-11 rounded-2xl bg-gradient-to-br from-[#7C3AED]/10 to-[#7C3AED]/5 text-[#7C3AED] text-xl font-extrabold shadow-sm border border-[#7C3AED]/10 flex-shrink-0">2</span>
                        ...
                        <RevealOnScroll>
                            <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
                                <div className="w-full lg:w-[65%] relative rounded-2xl overflow-hidden border border-gray-200 shadow-[0_20px_50px_rgba(124,58,237,0.08)] hover:shadow-[0_25px_60px_rgba(124,58,237,0.15)] transition-shadow duration-500 group bg-gray-50">
                                    <div className="aspect-[16/10] w-full relative">
                                        <Image src="/images/step2.png" alt="Step 3 Preview" priority fill sizes="(max-width: 1024px) 100vw, 65vw" className="object-cover object-top group-hover:scale-[1.02] transition-transform duration-700 ease-out hue-rotate-[45deg]" />
                                    </div>
                                </div>
                                <div className="w-full lg:w-[35%] flex flex-col items-start text-left">
                                    <div className="flex items-center gap-4 mb-3">
                                        <span className="flex items-center justify-center w-11 h-11 rounded-2xl bg-gradient-to-br from-[#7C3AED]/10 to-[#7C3AED]/5 text-[#7C3AED] text-xl font-extrabold shadow-sm border border-[#7C3AED]/10 flex-shrink-0">3</span>
                        ...
                        <RevealOnScroll>
                            <div className="flex flex-col lg:flex-row-reverse items-center gap-8 lg:gap-16">
                                <div className="w-full lg:w-[65%] relative rounded-2xl overflow-hidden border border-gray-200 shadow-[0_20px_50px_rgba(124,58,237,0.08)] hover:shadow-[0_25px_60px_rgba(124,58,237,0.15)] transition-shadow duration-500 group bg-gray-50">
                                    <div className="aspect-[16/10] w-full relative">
                                        <Image src="/images/step3.png" alt="Step 4 Preview" priority fill sizes="(max-width: 1024px) 100vw, 65vw" className="object-cover object-top group-hover:scale-[1.02] transition-transform duration-700 ease-out hue-rotate-[45deg]" />
                                    </div>
                                </div>
                                <div className="w-full lg:w-[35%] flex flex-col items-start text-left">
                                    <div className="flex items-center gap-4 mb-3">
                                        <span className="flex items-center justify-center w-11 h-11 rounded-2xl bg-gradient-to-br from-[#7C3AED]/10 to-[#7C3AED]/5 text-[#7C3AED] text-xl font-extrabold shadow-sm border border-[#7C3AED]/10 flex-shrink-0">4</span>
                    ...
                    <div className="relative w-full max-w-[1200px] mx-auto overflow-hidden rounded-[32px] sm:rounded-[40px] bg-gradient-to-b from-[#0F0A1F] via-[#1E0B4A] to-[#2E1065] border border-purple-500/20 shadow-2xl transition-all duration-700 group py-16 sm:py-24 md:py-28 flex flex-col items-center justify-center text-center px-4">
                        ...
                        <div className="relative z-10 mb-6 sm:mb-8 flex justify-center w-full sm:w-auto">
                            <div className="relative group/btn flex items-center justify-center w-full sm:w-auto p-[2px] rounded-full overflow-hidden bg-brand-primary shadow-md hover:shadow-xl hover:shadow-brand-primary/30 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300 ease-out">
                                {/* Blurred rotating glow (comet tail) */}
                                <div className="absolute inset-0 flex items-center justify-center blur-[4px] opacity-70 group-hover/btn:opacity-100 transition-opacity duration-300">
                                    <div className="w-[300%] h-[300%] animate-[spin_2.5s_linear_infinite]" style={{ background: "conic-gradient(from 0deg, transparent 20%, rgba(255,255,255,0.8) 45%, #ffffff 50%, transparent 50%, transparent 70%, rgba(255,255,255,0.8) 95%, #ffffff 100%)" }}></div>
                                </div>
                                ...
                                <Link href="/contactus" prefetch={false} className="relative z-10 flex items-center justify-center w-full sm:w-auto px-8 sm:px-10 py-3 sm:py-3.5 md:py-4 rounded-full bg-brand-primary group-hover/btn:bg-brand-primary-hover text-white text-[15px] sm:text-base font-semibold transition-all duration-300 ease-out cursor-pointer">
                                    <span>Contact Us</span>
                                    <span className="inline-block transition-transform duration-300 ease-out group-hover/btn:translate-x-1.5 ml-3">→</span>
                                </Link>
                            </div>
                        </div>
